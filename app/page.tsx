    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-neutral-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <span className="font-[family-name:var(--font-display)] text-2xl text-neutral-900">nat</span>
      ...
      <header className="max-w-6xl mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-neutral-500 leading-relaxed mb-10 max-w-2xl">
            A beautiful site with built-in reservations, menu, events, and CRM. One platform, one bill. Not $500/mo for Resy + BentoBox.
          </p>
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            { title: "Branded Website", desc: "5 themes designed for restaurants. Menu, about, gallery, contact pages. Your domain, your brand. Not a listing on someone else's platform." },
            { title: "Reservations", desc: "Built-in booking with real availability. Table assignment, turn times, party size. No per-cover fees. No $249/mo plans." },
            ...
            { title: "Guest CRM", desc: "Every guest who books builds a profile. Visit history, preferences, dietary notes, tags. Your data, not OpenTable's." },
            { title: "Events", desc: "Wine dinners, tasting menus, pop-ups. Event pages with booking, capacity management. The feature Resy doesn't have." },
            { title: "Custom Domains", desc: "Your restaurant on your domain. chezlaurent.com, not platform.com/chez-laurent. SSL included. Setup takes 2 minutes." },
            ...
            { title: "One Codebase", desc: "All 5 themes from one component. Change a database column and the whole site transforms. No duplicate code. Built to scale." },
          ].map((f) => (
            <div key={f.title}>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-24">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-neutral-500 mb-12">
            One plan. Everything included. No per-cover fees. No surprise charges.
          </p>
          <div className="border-2 border-neutral-900 rounded-2xl p-10">
            ...
            <p className="text-sm text-neutral-400 mt-6">
              Compare: Resy ($249–899/mo) + BentoBox ($99–199/mo) = $348–1098/mo
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-neutral-100 py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <span className="font-[family-name:var(--font-display)] text-xl text-neutral-900">nat</span>
