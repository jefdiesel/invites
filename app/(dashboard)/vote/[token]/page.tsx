...
export default async function VotePage({ params }: { params: Promise<{ token: string }> }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-sm text-center">
          ...
          <h1 className="text-xl font-bold text-warm-900">Already voted</h1>
  ...
  if (poll.phase !== "polling") {
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-sm text-center">
          <h1 className="text-xl font-bold text-warm-900">Poll closed</h1>
  ...
  return (
    <main className="max-w-lg mx-auto px-6 py-10">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-warm-900">{poll.title}</h1>
